...
abstract class MyfileDatabase : RoomDatabase() {
     ...
     */
    abstract val myfileDatabaseDao: MyfileDatabaseDao
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: MyfileDatabase? = null
         ...
         */
        fun getInstance(context: Context): MyfileDatabase {
